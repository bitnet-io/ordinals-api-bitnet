...
- [`isDocument(bar): boolean`](https://eemeli.org/yaml/#identifying-nodes)
- [`parseAllDocuments(str, options?): Document[]`](https://eemeli.org/yaml/#parsing-documents)
- [`parseDocument(str, options?): Document`](https://eemeli.org/yaml/#parsing-documents)

### Content Nodes

- [`isAlias(bar): boolean`](https://eemeli.org/yaml/#identifying-nodes)
- [`isCollection(bar): boolean`](https://eemeli.org/yaml/#identifying-nodes)
- [`isMap(bar): boolean`](https://eemeli.org/yaml/#identifying-nodes)
- [`isNode(bar): boolean`](https://eemeli.org/yaml/#identifying-nodes)
- [`isPair(bar): boolean`](https://eemeli.org/yaml/#identifying-nodes)
- [`isScalar(bar): boolean`](https://eemeli.org/yaml/#identifying-nodes)
- [`isSeq(bar): boolean`](https://eemeli.org/yaml/#identifying-nodes)
