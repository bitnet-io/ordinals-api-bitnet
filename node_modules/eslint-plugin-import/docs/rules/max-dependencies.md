...
Importing multiple named exports from a single module will only count once (e.g. `import {x, y, z} from './bar'` will only count as a single dependency).
