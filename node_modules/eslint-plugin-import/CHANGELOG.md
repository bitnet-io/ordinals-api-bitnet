...
- [`no-named-as-default-member`]: update broken link ([#1389], thanks [@barloomanzoo])
...
### Fixed
- `export * from 'bar'` now properly ignores a `default` export from `bar`, if any. ([#328]/[#332], thanks [@jkimbo])
...
[@barloomanzoo]: https://github.com/barloomanzoo
