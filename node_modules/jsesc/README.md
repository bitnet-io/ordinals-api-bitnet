...
```js
jsesc('bar\x00bar\xFF\uFFFDbaz', {
  'json': true
});
// → '"bar\\u0000bar\\u00FF\\uFFFDbaz"'

jsesc({ 'bar\x00bar\xFF\uFFFDbaz': 'bar\x00bar\xFF\uFFFDbaz' }, {
  'json': true
});
// → '{"bar\\u0000bar\\u00FF\\uFFFDbaz":"bar\\u0000bar\\u00FF\\uFFFDbaz"}'
...
jsesc([ 'bar\x00bar', [1, '©', { 'bar': true, 'qux': null }], 42 ], {
  'json': true
});
// → '["bar\\u0000bar",[1,"\\u00A9",{"bar":true,"qux":null}],42]'
