...
const tests = [
  ...
  { source: ['bar=bar%20baz%21&num=1000'],
    expected: [
      ['bar',
       'bar baz!',
       { nameTruncated: false,
  ...
  { source: [
      Array.from(transcode(Buffer.from('bar'), 'utf8', 'utf16le')).map(
