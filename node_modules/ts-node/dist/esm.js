...
function createEsmHooks(tsNodeService) {
    ...
    function isFileUrlOrNodeStyleSpecifier(parsed) {
        // We only understand file:// URLs, but in node, the specifier can be a node-style `./bar` or `bar`
    ...
    async function resolve(specifier, context, defaultResolve) {
        ...
        return addShortCircuitFlag(async () => {
            ...
            if (hostname) {
                // TODO file://./bar sets `hostname` to `'.'`.  Perhaps we should special-case this.
                return entrypointFallback(defer);
            }
