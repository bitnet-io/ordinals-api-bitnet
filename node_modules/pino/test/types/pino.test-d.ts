...
log.level = "error";
log.info("nope");
const child = log.child({ bar: "bar" });
child.info("nope again");
child.level = "info";
child.info("hooray");
log.info("nope nope nope");
log.child({ bar: "bar" }, { level: "debug" }).debug("debug!");
child.bindings();
...
fn(customLevelChildLogger); // missing bar typing
