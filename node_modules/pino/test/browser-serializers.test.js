...
if (process.title !== 'browser') {
  ...
  test('in browser, serializers apply to all objects', ({ end, is }) => {
    ...
    logger.fatal({ key: 'test' }, { key2: 'test' }, 'str should skip', [{ bar: 'array should skip' }], { key3: 'test' })
    end()
  })
  ...
  test('serialize filter applies to child loggers', ({ end, is }) => {
    ...
    }).fatal({ key: 'test' }, { key2: 'test' }, 'str should skip', [{ bar: 'array should skip' }], { key3: 'test' })
    end()
  })
