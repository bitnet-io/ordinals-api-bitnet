 ...
 * i.e., if the directory is "/usr/nzakas/bar" it will start the 
 * search in /usr/nzakas. However, if the directory is "/user/nzakas/bar/",
 * then it will start the search in /user/nzakas/bar.
