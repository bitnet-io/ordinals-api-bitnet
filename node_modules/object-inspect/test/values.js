...
test('arrays with properties', function (t) {
    ...
    obj.baz = 'quux';
    obj.index = -1;
    t.equal(inspect(obj), '[ 1, 2, [ 3, bar: \'bar\' ], baz: \'quux\', index: -1 ]');
});
...
test('symbols', { skip: !hasSymbols }, function (t) {
    var sym = Symbol('bar');
    t.equal(inspect(sym), 'Symbol(bar)', 'Symbol("bar") should be "Symbol(bar)"');
    if (typeof sym === 'symbol') {
        // Symbol shams are incapable of differentiating boxed from unboxed symbols
        t.equal(inspect(Object(sym)), 'Object(Symbol(bar))', 'Object(Symbol("bar")) should be "Object(Symbol(bar))"');
    }
