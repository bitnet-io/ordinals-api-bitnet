...
declare namespace ts {
    ...
    export interface ExportDeclaration extends DeclarationStatement, JSDocContainer {
        ...
        readonly parent: SourceFile | ModuleBlock;
        readonly isTypeOnly: boolean;
        /** Will not be assigned in the case of `export * from "bar";` */
    ...
    export interface PackageId {
         ...
         * If accessing a non-index file, this should include its name e.g. "bar/bar".
         */
        name: string;
        /**
    ...
    export interface UserPreferences {
        ...
        /** Determines whether we import `bar/index.ts` as "bar", "bar/index", or "bar/index.js" */
...
declare namespace ts {
    ...
    enum ScriptElementKind {
        ...
        /** class X { [public|private]* bar() {} } */
        memberFunctionElement = "method",
        /** class X { [public|private]* [get|set] bar:number; } */
        memberGetAccessorElement = "getter",
        memberSetAccessorElement = "setter",
        /**
         * class X { [public|private]* bar:number; }
         * interface Y { bar:number; }
         */
...
declare namespace ts.server.protocol {
    ...
    interface UserPreferences {
         ...
         * E.g., `class A { f| }` could be completed to `class A { bar(): number {} }`, instead of
         * `class A { bar }`.
         */
        readonly includeCompletionsWithClassMemberSnippets?: boolean;
        /**
         ...
         * E.g., `const objectLiteral: T = { f| }` could be completed to `const objectLiteral: T = { bar(): void {} }`,
         * in addition to `const objectLiteral: T = { bar }`.
         */
        readonly includeCompletionsWithObjectLiteralMethodSnippets?: boolean;
        /**
