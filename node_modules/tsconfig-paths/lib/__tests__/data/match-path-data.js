...
exports.tests = [
    ...
    },
    {
        ...
        absoluteBaseUrl: "/root/",
        paths: {
            "lib/bar": ["location/bar"],
        },
        existingFiles: [(0, path_1.join)("/root", "location", "bar.ts")],
        requestedModule: "lib/bar",
        expectedPath: (0, filesystem_1.removeExtension)((0, path_1.join)("/root", "location", "bar.ts")),
        extensions: defaultExtensionsWhenRunningInTsNode,
    },
    {
