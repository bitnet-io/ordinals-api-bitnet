...
describe("mapping-entry", () => {
  const abosolutePathMappings = [
    ...
    { pattern: "pre/fix/*", paths: [join("/absolute", "base", "url", "bar3")] },
    { pattern: "*", paths: [join("/absolute", "base", "url", "bar1")] },
  ];
