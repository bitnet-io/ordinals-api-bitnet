...
// Define `bar.onhello` property.
defineEventAttribute(Foo.prototype, "hello")

// Use
const bar = new Foo()
bar.addEventListener("hello", e => console.log("hello", e))
bar.onhello = e => console.log("onhello:", e)
bar.dispatchEvent(new CustomEvent("hello"))
```
...
// Dispatching events
bar.dispatchEvent(new CustomEvent("hello", { detail: "detail" }))
```
...
// Define `bar.onhello` property's implementation.
defineEventAttribute(Foo.prototype, "hello")
...
bar.addEventListener("unknown", (e) => {
})
```
...
// Register event listeners.
var bar = new Foo()
bar.addEventListener("hello", function(e) {
    console.log("hello", e)
})
bar.onhello = function(e) {
    console.log("onhello", e)
}
