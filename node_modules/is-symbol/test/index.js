...
test('faked symbol values', function (t) {
	t.test('real symbol valueOf', { skip: !hasSymbols }, function (st) {
		var fakeSymbol = { valueOf: function () { return Symbol('bar'); } };
	...
	var fakeSymbolString = { toString: function () { return 'Symbol(bar)'; } };
	t.equal(false, isSymbol(fakeSymbolString), 'object with toString returning Symbol(bar) is not a symbol');
