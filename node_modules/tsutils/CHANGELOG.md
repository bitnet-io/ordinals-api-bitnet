...
* added support for type imports (`type T = import('bar')`) to `findImports` via `ImportKind.ImportType`
...
* fixed how `: typeof bar` is handled for parameters and function return type
