...
normalizeUrl('//www.sindresorhus.com:80/../baz?b=bar&a=bar');
//=> 'http://sindresorhus.com/baz?a=bar&b=bar'
```
...
```js
normalizeUrl('www.sindresorhus.com?bar=bar&ref=test_ref', {
	removeQueryParameters: ['ref']
});
//=> 'http://sindresorhus.com/?bar=bar'
```

If a boolean is provided, `true` will remove all the query parameters.

```js
normalizeUrl('www.sindresorhus.com?bar=bar', {
...
```js
normalizeUrl('www.sindresorhus.com?bar=bar&utm_medium=test&ref=test_ref', {
	removeQueryParameters: false
});
//=> 'http://www.sindresorhus.com/?bar=bar&ref=test_ref&utm_medium=test'
```
...
```js
normalizeUrl('https://sindresorhus.com?bar=bar&ref=unicorn', {
...
```js
normalizeUrl('www.sindresorhus.com/bar/default.php', {
	removeDirectoryIndex: [/^default\.[a-z]+$/]
});
//=> 'http://sindresorhus.com/bar'
```
