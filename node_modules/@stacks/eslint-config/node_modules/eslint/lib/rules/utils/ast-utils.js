...
module.exports = {
    ...
    isDefaultThisBinding(node, sourceCode, { capIsConstructor = true } = {}) {
        ...
        while (currentNode) {
            ...
            switch (parent.type) {
                 ...
                 * e.g., obj.bar = nativeFoo || function bar() { ... };
                 */
                ...
                /*
                 * e.g.
                 *   var bar = function bar() { ... }.bind(obj);
                 *   (function bar() { ... }).call(obj);
                 *   (function bar() { ... }).apply(obj, []);
                 */
                case "MemberExpression":
                    if (
     ...
     * - `(function bar() {})`  .................. `function 'bar'`
     * - `(function() {})`  ...................... `function`
     * - `function* bar() {}`  ................... `generator function 'bar'`
     * - `(function* bar() {})`  ................. `generator function 'bar'`
     * - `(function*() {})`  ..................... `generator function`
     * - `() => {}`  ............................. `arrow function`
     * - `async () => {}`  ....................... `async arrow function`
     * - `({ bar: function bar() {} })`  ......... `method 'bar'`
     * - `({ bar: function() {} })`  ............. `method 'bar'`
     * - `({ ['bar']: function() {} })`  ......... `method 'bar'`
     * - `({ [bar]: function() {} })`  ........... `method`
     * - `({ bar() {} })`  ....................... `method 'bar'`
     * - `({ bar: function* bar() {} })`  ........ `generator method 'bar'`
     * - `({ bar: function*() {} })`  ............ `generator method 'bar'`
     * - `({ ['bar']: function*() {} })`  ........ `generator method 'bar'`
     * - `({ [bar]: function*() {} })`  .......... `generator method`
     * - `({ *bar() {} })`  ...................... `generator method 'bar'`
     * - `({ bar: async function bar() {} })`  ... `async method 'bar'`
     * - `({ bar: async function() {} })`  ....... `async method 'bar'`
     * - `({ ['bar']: async function() {} })`  ... `async method 'bar'`
     * - `({ [bar]: async function() {} })`  ..... `async method`
     * - `({ async bar() {} })`  ................. `async method 'bar'`
     * - `({ get bar() {} })`  ................... `getter 'bar'`
     * - `({ set bar(a) {} })`  .................. `setter 'bar'`
     * - `class A { constructor() {} }`  ......... `constructor`
     * - `class A { bar() {} }`  ................. `method 'bar'`
     * - `class A { *bar() {} }`  ................ `generator method 'bar'`
     * - `class A { async bar() {} }`  ........... `async method 'bar'`
     * - `class A { ['bar']() {} }`  ............. `method 'bar'`
     * - `class A { *['bar']() {} }`  ............ `generator method 'bar'`
     * - `class A { async ['bar']() {} }`  ....... `async method 'bar'`
     * - `class A { [bar]() {} }`  ............... `method`
     * - `class A { *[bar]() {} }`  .............. `generator method`
     * - `class A { async [bar]() {} }`  ......... `async method`
     * - `class A { get bar() {} }`  ............. `getter 'bar'`
     * - `class A { set bar(a) {} }`  ............ `setter 'bar'`
     * - `class A { static bar() {} }`  .......... `static method 'bar'`
     * - `class A { static *bar() {} }`  ......... `static generator method 'bar'`
     * - `class A { static async bar() {} }`  .... `static async method 'bar'`
     * - `class A { static get bar() {} }`  ...... `static getter 'bar'`
     * - `class A { static set bar(a) {} }`  ..... `static setter 'bar'`
     * - `class A { bar = () => {}; }`  .......... `method 'bar'`
     * - `class A { bar = function() {}; }`  ..... `method 'bar'`
     * - `class A { bar = function bar() {}; }`  . `method 'bar'`
     * - `class A { static bar = () => {}; }`  ... `static method 'bar'`
     * - `class A { '#bar' = () => {}; }`  ....... `method '#bar'`
     * - `class A { #bar = () => {}; }`  ......... `private method #bar`
     * - `class A { static #bar = () => {}; }`  .. `static private method #bar`
     * - `class A { '#bar'() {} }`  .............. `method '#bar'`
     * - `class A { #bar() {} }`  ................ `private method #bar`
     * - `class A { static #bar() {} }`  ......... `static private method #bar`
     * @param {ASTNode} node The function node to get.
     ...
     * - `class A { static *bar() {} }`
     *              ^^^^^^^^^^^
     * - `class A { static async bar() {} }`
     *              ^^^^^^^^^^^^^^^^
     * - `class A { static get bar() {} }`
     *              ^^^^^^^^^^^^^^
     * - `class A { static set bar(a) {} }`
     *              ^^^^^^^^^^^^^^
     * - `class A { bar = function() {} }`
     *              ^^^^^^^^^^^^^^
     * - `class A { static bar = function() {} }`
     *              ^^^^^^^^^^^^^^^^^^^^^
     * - `class A { bar = (a, b) => {} }`
     *              ^^^^^^
     * @param {ASTNode} node The function node to get.
