 ...
 * E.g., for given `index === 1`, this function checks for `objectName.methodName(bar, node)`, where objectName is a global variable.
        ...
        return {
            ...
            ArrowFunctionExpression(node) {
                ...
                if (funcInfo.isSetter && node.expression) {
                    ...
                    // { set: bar => bar } property descriptor. Report implicit return 'bar' as the equivalent for a return statement.
                    report(node.body);
                }
            },
