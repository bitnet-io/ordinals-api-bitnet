...
module.exports = {
    ...
    create(context) {
         ...
         *
         * - `<div className="bar"></div>` ... If the literal is an attribute value, the parent of the literal is `JSXAttribute`.
         * - `<div>bar</div>` ... If the literal is a text content, the parent of the literal is `JSXElement`.
         * - `<>bar</>` ... If the literal is a text content, the parent of the literal is `JSXFragment`.
         *
