...
const domain = 'https://example.com/bar#bar$fiz'
const ipv4 = '//10.10.10.10'
const ipv6 = '//[2001:db8::7]'
const urn = 'urn:bar:a123,456'
...
suite.add('fast-uri: serialize ws', function () {
  fasturi.serialize({ scheme: 'ws', host: 'example.com', resourceName: '/bar?bar', secure: true })
})
suite.add('urijs: serialize ws', function () {
  urijs.serialize({ scheme: 'ws', host: 'example.com', resourceName: '/bar?bar', secure: true })
})
