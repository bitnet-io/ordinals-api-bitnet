...
test('URI Serialize', (t) => {
  ...
  t.equal(URI.serialize(components), 'uri://bar:bar@example.com:1/path?query#fragment', 'All Components')
  ...
  t.equal(URI.serialize({ path: 'bar:bar' }), 'bar%3Abar', 'Colon path')
...
test('WS serialize', (t) => {
  ...
  t.equal(URI.serialize({ scheme: 'ws', resourceName: '/bar' }), 'ws:/bar')
  t.equal(URI.serialize({ scheme: 'ws', resourceName: '/bar?bar' }), 'ws:/bar?bar')
  t.equal(URI.serialize({ scheme: 'ws', secure: false }), 'ws:')
  t.equal(URI.serialize({ scheme: 'ws', secure: true }), 'wss:')
  t.equal(URI.serialize({ scheme: 'ws', host: 'example.com', resourceName: '/bar' }), 'ws://example.com/bar')
  t.equal(URI.serialize({ scheme: 'ws', host: 'example.com', resourceName: '/bar?bar' }), 'ws://example.com/bar?bar')
  ...
  t.equal(URI.serialize({ scheme: 'ws', host: 'example.com', resourceName: '/bar?bar', secure: false }), 'ws://example.com/bar?bar')
  t.equal(URI.serialize({ scheme: 'ws', host: 'example.com', resourceName: '/bar?bar', secure: true }), 'wss://example.com/bar?bar')
  t.end()
})
...
test('WSS serialize', (t) => {
  ...
  t.equal(URI.serialize({ scheme: 'wss', resourceName: '/bar' }), 'wss:/bar')
  t.equal(URI.serialize({ scheme: 'wss', resourceName: '/bar?bar' }), 'wss:/bar?bar')
  t.equal(URI.serialize({ scheme: 'wss', secure: false }), 'ws:')
  t.equal(URI.serialize({ scheme: 'wss', secure: true }), 'wss:')
  t.equal(URI.serialize({ scheme: 'wss', host: 'example.com', resourceName: '/bar' }), 'wss://example.com/bar')
  t.equal(URI.serialize({ scheme: 'wss', host: 'example.com', resourceName: '/bar?bar' }), 'wss://example.com/bar?bar')
  ...
  t.equal(URI.serialize({ scheme: 'wss', host: 'example.com', resourceName: '/bar?bar', secure: false }), 'ws://example.com/bar?bar')
  t.equal(URI.serialize({ scheme: 'wss', host: 'example.com', resourceName: '/bar?bar', secure: true }), 'wss://example.com/bar?bar')
...
// example from RFC 2141
  ...
  t.equal(URI.serialize(components), 'urn:bar:a123,456')
...
test('URN NID Override', (t) => {
  ...
  t.equal(URI.serialize(components, { nid: 'uuid' }), 'urn:bar:f81d4fae-7dec-11d0-a765-00a0c91e6bf6')
  t.end()
})
