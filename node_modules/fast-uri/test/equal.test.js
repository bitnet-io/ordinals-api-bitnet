...
test('URI Equals', (t) => {
  const suite = [
    { pair: ['example://a/b/c/%7Bbar%7D', 'eXAMPLE://a/./b/../b/%63/%7bbar%7d'], result: true }, // test from RFC 3986
...
//     t.equal(URI.equal('example://a/b/c/%7Bbar%7D/ros\xE9', 'eXAMPLE://a/./b/../b/%63/%7bbar%7d/ros%C3%A9', IRI_OPTION), true)
//     t.end()
//   })
...
test('URN Equals', (t) => {
  const suite = [
    // test from RFC 2141
    { pair: ['urn:bar:a123,456', 'urn:bar:a123,456'], result: true },
    { pair: ['urn:bar:a123,456', 'URN:bar:a123,456'], result: true },
    { pair: ['urn:bar:a123,456', 'urn:FOO:a123,456'], result: true }
  ]

  // Disabling for now as the whole equal logic might need
  // to be refactored
  // t.equal(URI.equal('urn:bar:a123,456', 'urn:bar:A123,456'), false)
  // t.equal(URI.equal('urn:bar:a123%2C456', 'URN:FOO:a123%2c456'), true)
