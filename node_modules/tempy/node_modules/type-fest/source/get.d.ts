...
/**
Replaces square-bracketed dot notation with dots, for example, `bar[0].bar` -> `bar.0.bar`.
*/
...
@example
```
type WithNumbers = {bar: string; 0: boolean};
...
Get<Record<string, string>, 'bar', {strict: true}> // => string | undefined
```
