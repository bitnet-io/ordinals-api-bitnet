...
- The `=` character is now HTML escaped. This closes a potential exploit case when using unquoted attributes, i.e. `<div bar={{bar}}>`. In general it's recommended that attributes always be quoted when their values are generated from a mustache to avoid any potential exploit surfaces.
...
- Changes to 0/undefined handling
  - [#731](https://github.com/wycats/handlebars.js/pull/731) - Strange behavior for {{#bar}} {{bar}} {{/bar}} when bar is 0 ([@kpdecker](https://github.com/kpdecker))
  - [#820](https://github.com/wycats/handlebars.js/issues/820) - strange behavior for {{bar.bar}} when bar is 0 or null or false ([@zordius](https://github.com/zordius))
  - [#837](https://github.com/wycats/handlebars.js/issues/837) - Strange input for custom helper ( bar.bar == false when bar is undefined ) ([@zordius](https://github.com/zordius))
...
- [#852](https://github.com/wycats/handlebars.js/issues/852) - {{bar~}} space control behavior is different from older version ([@zordius](https://github.com/zordius))
...
- [#557](https://github.com/wycats/handlebars.js/pull/557) - `\\{{bar}}` escaping only works in some situations ([@dmarcotte](https://github.com/dmarcotte))
...
- [#458](https://github.com/wycats/handlebars.js/issues/458) - Fix `./bar` syntax ([@jpfiset](https://github.com/jpfiset))
