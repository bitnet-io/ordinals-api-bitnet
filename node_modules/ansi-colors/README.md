...
```js
console.log(c.yellow(`bar ${c.red.bold('red')} bar ${c.cyan('cyan')} baz`));
```
...
console.log(bold(`bar ${red.dim('bar')} baz`));

const colorette = require('colorette');
console.log(colorette.bold(`bar ${colorette.red(colorette.dim('bar'))} baz`));

const kleur = require('kleur');
console.log(kleur.bold(`bar ${kleur.red.dim('bar')} baz`));

const chalk = require('chalk');
console.log(chalk.bold(`bar ${chalk.red.dim('bar')} baz`));
```
...
```js
console.log(c.unstyle(c.blue.bold('bar bar baz')));
//=> 'bar bar baz'
```
