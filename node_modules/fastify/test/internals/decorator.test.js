...
test('checkDependencies should throw if a dependency is not present', t => {
  ...
  const instance = {}
  try {
    decorator.dependencies(instance, 'bar', ['test'])
    t.fail()
  } catch (e) {
...
test('decorate should recognize getter/setter objects', t => {
  ...
  t.equal(Object.prototype.hasOwnProperty.call(one, 'bar'), true)
  t.equal(one.bar, undefined)
  one.bar = 'a'
  t.equal(one.bar, 'a')
  ...
  decorator.add.call(two, 'bar', {
    getter: () => 'a getter'
  })
  t.equal(Object.prototype.hasOwnProperty.call(two, 'bar'), true)
  t.equal(two.bar, 'a getter')
})
