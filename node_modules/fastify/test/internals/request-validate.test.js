        ...
        (req, reply) => {
          ...
          switch (params.id) {
            ...
            case 2:
              ...
              t.ok(headerValidation({ 'x-bar': 'world' }))
              t.notOk(headerValidation({ 'x-bar': [] }))
              break
            case 3:
            ...
            case 4:
              ...
              t.ok(req.getValidationFunction('querystring')({ bar: 'bar' }))
              t.notOk(
                req.getValidationFunction('querystring')({ bar: 'not-bar' })
              )
              break
            case 5:
              t.equal(
        ...
        (req, reply) => {
          ...
          switch (params.id) {
            case 1:
              ...
              t.notOk(req.validateInput({ hello: [], world: 'bar' }, 'body'))
              break
            case 2:
              t.notOk(req.validateInput({ bar: 'something' }, 'querystring'))
              t.ok(req.validateInput({ bar: 'bar' }, 'querystring'))
              break
            case 3:
              t.notOk(req.validateInput({ 'x-bar': [] }, 'headers'))
              t.ok(req.validateInput({ 'x-bar': 'something' }, 'headers'))
              break
            case 4:
      ...
      fastify.get('/:id', (req, reply) => {
        ...
        switch (parseInt(params.id)) {
          ...
          case 3:
            ...
            break
          case 4:
            req.validateInput({ 'x-bar': [] }, 'headers')
            break
          case 5:
      ...
      fastify.get('/:id', (req, reply) => {
        ...
        switch (parseInt(params.id)) {
          ...
          case 3:
            ...
            break
          case 4:
            req.validateInput({ 'x-bar': [] }, null, 'headers')
            break
          case 5:
            req.validateInput({ id: 0 }, () => {}, 'params')
            break
              ...
              (req, reply) => {
                ...
                switch (params.id) {
                  ...
                  case 4:
                    t.ok(req.getValidationFunction('querystring'))
                    t.ok(
                      req.getValidationFunction('querystring')({ bar: 'bar' })
                    )
                    t.notOk(
