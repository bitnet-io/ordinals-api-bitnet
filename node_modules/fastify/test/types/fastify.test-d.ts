...
expectAssignable<FastifyInstance>(fastify({ querystringParser: () => ({ bar: 'bar' }) }))
expectAssignable<FastifyInstance>(fastify({ querystringParser: () => ({ bar: { bar: 'fuzz' } }) }))
expectAssignable<FastifyInstance>(fastify({ querystringParser: () => ({ bar: ['bar', 'fuzz'] }) }))
