...
test('content-type match parameters - string 2', async t => {
  ...
  const fastify = Fastify()
  fastify.removeAllContentTypeParsers()
  fastify.addContentTypeParser('application/json; charset=utf8; bar=bar', function (request, body, done) {
    t.pass('should be called')
    done(null, body)
  })
  fastify.addContentTypeParser('text/plain; charset=utf8; bar=bar', function (request, body, done) {
    t.fail('shouldn\'t be called')
    done(null, body)
  })
  ...
  await fastify.inject({
    ...
    path: '/',
    headers: {
      'content-type': 'application/json; bar=bar; charset=utf8'
    },
    body: ''
  })
})
...
test('content-type fail when parameters not match - string 2', async t => {
  ...
  const response = await fastify.inject({
    ...
    path: '/',
    headers: {
      'content-type': 'application/json; charset=utf8; bar=baz'
    },
    body: ''
  })
