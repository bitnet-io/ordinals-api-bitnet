...
describe('uri-template', function () {
  describe('Level 1', function () {
    ...
    it('encodes non expressions correctly', function () {
      ...
      assert('Hello World!/{bar}', 'Hello%20World!/bar');
      assert(':/?#[]@!$&()*+,;=\'', ':/?#[]@!$&()*+,;=\'');
      assert('%20', '%20');
      assert('%xyz', '%25xyz');
      assert('%', '%25');
  ...
  describe('Level 2', function () {
    ...
    it('preserves paths', function() {
      assert('{+path}/here', '/bar/bar/here');
      assert('here?ref={+path}', 'here?ref=/bar/bar');
    });
  });
  ...
  describe('Level 3', function () {
    ...
    it('variables with the reserved expansion operator', function () {
      ...
      assert('{+path,x}/here', '/bar/bar,1024/here');
    });
  ...
  describe('Level 4', function () {
    ...
    it('variable list explode', function () {
      ...
      assert('{/list*,path:4}', '/red/green/blue/%2Fbar');
    });
  ...
  describe('Error handling (or the lack thereof)', function () {
    ...
    it('does not expand with incorrect operators', function () {
      assert('{@bar}', ''); // TODO: This will try to match a variable called `@bar` which will fail because it is not in our context. We could catch this by ignoring reserved operators?
      assert('{$bar}', ''); // TODO: Same story, but $ is not a reserved operator.
      assert('{++bar}', '');
    });

    it('ignores incorrect prefixes', function () {
      assert('{bar:test}', 'test'); // TODO: Invalid prefixes are ignored. We could throw an error.
      assert('{bar:2test}', 'te'); // TODO: Best effort is OK?
    });

    it('prefix applied to the wrong context', function () {
      assert('{keys:1}', 'bar,bar');
    });
  });
