...
-   The performance bartprint of MobX 5 should be pretty similar to MobX 4. In our performance tests we saw some minor improvements in memory bartprint, but overall it should be pretty comparable.
