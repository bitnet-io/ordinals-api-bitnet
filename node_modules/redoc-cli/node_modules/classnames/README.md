...
The argument `'bar'` is short for `{ bar: true }`. If the value associated with a given key is falsy, that key won't be included in the output.

```js
classNames('bar', 'bar'); // => 'bar bar'
classNames('bar', { bar: true }); // => 'bar bar'
classNames({ 'bar-bar': true }); // => 'bar-bar'
classNames({ 'bar-bar': false }); // => ''
classNames({ bar: true }, { bar: true }); // => 'bar bar'
classNames({ bar: true, bar: true }); // => 'bar bar'

// lots of arguments of various types
classNames('bar', { bar: true, duck: false }, 'baz', { quux: true }); // => 'bar bar baz quux'
...
classNames('bar', 'bar', 'bar'); // => 'bar bar'
classNames('bar', { bar: false, bar: true }); // => 'bar'
```
...
var className = cx('bar', ['bar'], { baz: true }); // => "abc def xyz"
```
