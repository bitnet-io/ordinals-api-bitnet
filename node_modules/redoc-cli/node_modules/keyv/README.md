...
await keyv.set('bar', 'expires in 1 second', 1000); // true
await keyv.set('bar', 'never expires'); // true
await keyv.get('bar'); // 'never expires'
await keyv.delete('bar'); // true
...
await users.set('bar', 'users'); // true
await cache.set('bar', 'cache'); // true
await users.get('bar'); // 'users'
await cache.get('bar'); // 'cache'
await users.clear(); // undefined
await users.get('bar'); // undefined
await cache.get('bar'); // 'cache'
```
