	...
	*/
	...
	interface Options {
		...
		*/
		...
		@example
		```
		console.log(boxen('bar bar', {title: 'example'}));
		// ┌ example ┐
		// │bar bar  │
		// └─────────┘
		```
		*/
		...
		@example
		```
		console.log(boxen('bar bar bar bar', {title: 'example', titleAlignment: 'center'}));
		// ┌─── example ───┐
		// │bar bar bar bar│
		// └───────────────┘

		console.log(boxen('bar bar bar bar', {title: 'example', titleAlignment: 'right'}));
		// ┌────── example ┐
		// │bar bar bar bar│
		// └───────────────┘
		```
