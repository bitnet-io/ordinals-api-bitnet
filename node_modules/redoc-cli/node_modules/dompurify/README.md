...
### Is there any bart-gun potential?
...
var clean = DOMPurify.sanitize(
    '<bar-bar baz="barbar" forbidden="true"></bar-bar><div is="bar-baz"></div>',
    {
...
var clean = DOMPurify.sanitize(
    ...
    {
        CUSTOM_ELEMENT_HANDLING: {
            tagNameCheck: /^bar-/, // allow all tags starting with "bar-"
            attributeNameCheck: /baz/, // allow all attributes containing "baz"
            allowCustomizedBuiltInElements: false, // customized built-ins are allowed
        },
    }
); // <bar-bar baz="barbar"></bar-bar><div is=""></div>

var clean = DOMPurify.sanitize(
    '<bar-bar baz="barbar" forbidden="true"></bar-bar><div is="bar-baz"></div>',
    {
        CUSTOM_ELEMENT_HANDLING: {
            tagNameCheck: (tagName) => tagName.match(/^bar-/), // allow all tags starting with "bar-"
            attributeNameCheck: (attr) => attr.match(/baz/), // allow all containing "baz"
            allowCustomizedBuiltInElements: true, // allow customized built-ins
        },
    }
); // <bar-bar baz="barbar"></bar-bar><div is="bar-baz"></div>
