...
`;var Fi=require("react-tabs");const Bi=ee(Fi.Tabs)`
  > ul {
    list-style: none;
    padding: 0;
    margin: 0;
...
`;class na extends e.Component{constructor(){super(...arguments),this.state={activeIdx:0},this.switchMedia=({idx:e})=>{void 0!==e&&this.setState({activeIdx:e})}}render(){const{activeIdx:t}=this.state,r=this.props.mediaType.examples||{},n=this.props.mediaType.name,o=e.createElement(ra,null,"No sample"),i=Object.keys(r);if(0===i.length)return o;if(i.length>1){const o=i.map(((e,t)=>({value:r[e].summary||e,idx:t}))),s=r[i[t]],a=s.description;return e.createElement(oa,null,e.createElement(ea,null,e.createElement(Ks,null,"Example"),this.props.renderDropdown({value:o[t].value,options:o,onChange:this.switchMedia,ariaLabel:"Example"})),e.createElement("div",null,a&&e.createElement(Rs,{source:a}),e.createElement(Zs,{example:s,mimeType:n})))}{const t=r[i[0]];return e.createElement(oa,null,t.description&&e.createElement(Rs,{source:t.description}),e.createElement(Zs,{example:t,mimeType:n}))}}}const oa=ee.div`
  margin-top: 15px;
`;var ia=require("mobx-react");const sa=ee(Ai)`
  button {
    background-color: transparent;
    border: 0;
    outline: 0;
...
`,qc=ee.span.attrs((e=>({className:`http-verb ${e.type}`})))`
