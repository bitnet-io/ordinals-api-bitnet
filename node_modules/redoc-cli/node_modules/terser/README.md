...
```bash
$ terser example.js -c passes=2 -m --mangle-props reserved=[bar_,bar_]
```
```javascript
var x={o:3,bar_:1,t:function(){return this.bar_+this.o},bar_:2};console.log(x.t());
```
...
```javascript
try {
    const result = await minify({"bar.js" : "if (0) else console.log(1);"});
...
- `typeofs` (default: `true`) -- Transforms `typeof bar == "undefined"` into
  `bar === void 0`.  Note: recommend to set this value to `false` for IE10 and
...
and build your code like this:
    ...
    terser build/defines.js js/bar.js js/bar.js... -c
