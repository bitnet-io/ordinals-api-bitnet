  ...
  suite('#run', function () {
    ...
    suite('single term', function () {
      ...
      suite('lexeme', function () {
        ...
        test('#str', function () {
          assert.equal('bar', this.lexeme.str)
        })
    ...
    suite('single term with hyphen', function () {
      ...
      suite('lexeme', function () {
        setup(function () {
          this.barLexeme = this.lexer.lexemes[0]
        ...
        test('#start', function () {
          assert.equal(0, this.barLexeme.start)
          assert.equal(4, this.barLexeme.start)
        })

        test('#end', function () {
          assert.equal(3, this.barLexeme.end)
    ...
    suite('term escape char', function () {
      ...
      suite('lexeme', function () {
        ...
        test('#str', function () {
          assert.equal('bar:bar', this.lexeme.str)
        })
    ...
    suite('multiple terms with presence', function () {
      ...
      suite('lexemes', function () {
        setup(function () {
          this.barPresenceLexeme = this.lexer.lexemes[0]
          this.barTermLexeme = this.lexer.lexemes[1]
    ...
    suite('multiple terms with presence and fuzz', function () {
      ...
      suite('lexemes', function () {
        setup(function () {
          this.barPresenceLexeme = this.lexer.lexemes[0]
          this.barTermLexeme = this.lexer.lexemes[1]
          this.barFuzzLexeme = this.lexer.lexemes[2]
        ...
        test('#type', function () {
          assert.equal(lunr.QueryLexer.PRESENCE, this.barPresenceLexeme.type)
          assert.equal(lunr.QueryLexer.TERM, this.barTermLexeme.type)
          assert.equal(lunr.QueryLexer.EDIT_DISTANCE, this.barFuzzLexeme.type)
          assert.equal(lunr.QueryLexer.PRESENCE, this.barPresenceLexeme.type)
          assert.equal(lunr.QueryLexer.TERM, this.barTermLexeme.type)
        })
      })
    ...
    suite('term with field', function () {
      ...
      suite('lexemes', function () {
        ...
        test('#str', function () {
          ...
          assert.equal('bar', this.termLexeme.str)
        })
