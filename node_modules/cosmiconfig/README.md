...
If nested property names within the path include periods, you need to use an array of strings. For example, the value `['configs', 'bar.bar', 'baz']` will get you the `"baz"` value in a `package.json` like this:
