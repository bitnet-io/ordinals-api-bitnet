...
test('symlink', function (t) {
    ...
    resolve('bar', { basedir: symlinkDir, preserveSymlinks: false }, function (err, res, pkg) {
        t.error(err);
        t.equal(res, path.join(__dirname, 'resolver', 'symlinked', '_', 'node_modules', 'bar.js'));
    });
});
...
test('sync symlink when preserveSymlinks = true', function (t) {
    ...
    resolve('bar', { basedir: symlinkDir }, function (err, res, pkg) {
        ...
        t.equal(
            err && err.message,
            'Cannot find module \'bar\' from \'' + symlinkDir + '\'',
...
test('sync symlink', function (t) {
    ...
    t.doesNotThrow(function () {
        t.equal(
            resolve.sync('bar', { basedir: symlinkDir, preserveSymlinks: false }),
            path.join(__dirname, 'resolver', 'symlinked', '_', 'node_modules', 'bar.js')
        );
    });
...
test('sync symlink when preserveSymlinks = true', function (t) {
    t.throws(function () {
        resolve.sync('bar', { basedir: symlinkDir });
