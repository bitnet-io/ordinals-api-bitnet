...
test('mock', function (t) {
    ...
    t.equal(
        resolve.sync('./baz', opts('/bar/bar')),
        path.resolve('/bar/bar/baz.js')
    );

    t.equal(
        resolve.sync('./baz.js', opts('/bar/bar')),
        path.resolve('/bar/bar/baz.js')
    );
...
test('mock package', function (t) {
    ...
    t.equal(
        resolve.sync('bar', opts('/bar')),
        path.resolve('/bar/node_modules/bar/baz.js')
    );
});
...
test('symlinked', function (t) {
    ...
    t.equal(
        resolve.sync('./baz', opts('/bar/bar')),
        path.resolve('/bar/bar/symlinked/baz.js')
    );
...
test('readPackageSync', function (t) {
    ...
    t.test('with readPackage', function (st) {
        ...
        st.equal(
            ...
            path.resolve('/bar/node_modules/bar/something-else.js')
        );
    });
