...
var run = function (args /* , logger: Logger*/) { return __awaiter(void 0, void 0, void 0, function () {
    var nullLogger, file, filePath, bartNotes, name, isPackage, actualConfig, migratedConfig, presetName, preset, jsTransformers, jsWithTs, jsWithBabel, presetValue, migratedValue, presetValue, migratedValue, globalsTsJestConfig, migratedConfigTransform, presetValueTransform_1, before, after, stringify, prefix;
        ...
        if (!migratedConfig.preset && args.jestPreset) {
            ...
            if (args.js) {
                ...
                jsTransformers = Object.keys(migratedConfig.transform || {}).reduce(function (list, pattern) {
                    if (RegExp(pattern.replace(/^<rootDir>\/?/, '/dummy-project/')).test('/dummy-project/src/bar.js')) {
                        // eslint-disable-next-line @typescript-eslint/no-explicit-any
            ...
            bartNotes.push("Detected preset '".concat(preset.label, "' as the best matching preset for your configuration.\nVisit https://kulshekhar.github.io/ts-jest/user/config/#jest-preset for more information about presets.\n"));
        }
