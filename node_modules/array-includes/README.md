...
assert.equal(includes(arr, 'bar', 0), true);
assert.equal(includes(arr, 'bar', 1), true);
assert.equal(includes(arr, 'bar', 2), false);
```
...
assert.equal(arr.includes('bar', 1), includes(arr, 'bar', 1));
```
...
assert.equal(arr.includes(1, 'bar'), includes(arr, 1, 'bar'));
```
