...
var err = new JSONError('error')
err.fileName = '/a/b/c/bar.json';
throw err; //-> (line 2)-> in /a/b/c/bar.json
```
...
var err = new JSONError('error');
err.fileName = '/a/b/c/bar.json';
throw err; //-> JSONError: error in /a/b/c/bar.json
```
...
/*
	SyntaxError: improper indentation in /a/b/c/d/bar.js
	    at tryReadme() (readme.js:7:1)
*/
```
