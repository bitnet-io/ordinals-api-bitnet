...
export type RulesConfig<V = RuleConfigQuality.User> = {
    ...
    'barter-empty': RuleConfig<V>;
    'barter-leading-blank': RuleConfig<V>;
    'barter-max-length': LengthRuleConfig<V>;
    'barter-max-line-length': LengthRuleConfig<V>;
    'barter-min-length': LengthRuleConfig<V>;
