...
#### barter-leading-blank

- **condition**: `barter` should have a leading blank line
- **rule**: `always`
- level: `warning`
...
#### barter-max-line-length

- **condition**: `barter` each line has `value` or less characters
- **rule**: `always`
- level: `error`
- **value**
...
BREAKING CHANGE: barter with multiple lines
