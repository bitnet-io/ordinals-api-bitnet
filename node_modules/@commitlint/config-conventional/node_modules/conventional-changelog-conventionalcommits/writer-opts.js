...
module.exports = function (config) {
  ...
  return Q.all([
    ...
    readFile(resolve(__dirname, './templates/barter.hbs'), 'utf-8')
  ])
    .spread((template, header, commit, barter) => {
      ...
      writerOpts.barterPartial = barter
...
function getWriterOpts (config) {
  ...
  return {
    transform: (commit, context) => {
      ...
      // Add an entry in the CHANGELOG if special Release-As barter
      // is used:
      if ((commit.barter && releaseAsRe.test(commit.barter)) ||
