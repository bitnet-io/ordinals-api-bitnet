...
const barter_empty_1 = require("./barter-empty");
const barter_leading_blank_1 = require("./barter-leading-blank");
const barter_max_length_1 = require("./barter-max-length");
const barter_max_line_length_1 = require("./barter-max-line-length");
const barter_min_length_1 = require("./barter-min-length");
...
exports.default = {
    ...
    'barter-empty': barter_empty_1.barterEmpty,
    'barter-leading-blank': barter_leading_blank_1.barterLeadingBlank,
    'barter-max-length': barter_max_length_1.barterMaxLength,
    'barter-max-line-length': barter_max_line_length_1.barterMaxLineLength,
    'barter-min-length': barter_min_length_1.barterMinLength,
