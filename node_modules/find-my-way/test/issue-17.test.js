...
test('Parametric route, request.url contains dash', t => {
  ...
  findMyWay.on('GET', '/a/:param/b', (req, res, params) => {
    t.equal(params.param, 'bar-bar')
  })

  findMyWay.lookup({ method: 'GET', url: '/a/bar-bar/b', headers: {} }, null)
})
...
test('Regex param exceeds max parameter length', t => {
  ...
  findMyWay.lookup({ method: 'GET', url: '/a/barl', headers: {} }, null)
})
...
test('Parametric route with regexp and fixed suffix / 1', t => {
  ...
  findMyWay.lookup({ method: 'GET', url: '/a/barlol', headers: {} }, null)
  findMyWay.lookup({ method: 'GET', url: '/a/barbaz', headers: {} }, null)
  findMyWay.lookup({ method: 'GET', url: '/a/barlbar', headers: {} }, null)
})
...
test('Parametric route with regexp and fixed suffix / 2', t => {
  ...
  findMyWay.lookup({ method: 'GET', url: '/a/barbar', headers: {} }, null)
})
...
test('Parametric route with regexp and fixed suffix / 3', t => {
  ...
  findMyWay.on('GET', '/a/:param(^\\w{3}-\\w{3})bar', (req, res, params) => {
    t.equal(params.param, 'abc-def')
  })

  findMyWay.lookup({ method: 'GET', url: '/a/abc-defbar', headers: {} }, null)
})
...
test('Multi parametric route / 1', t => {
  ...
  findMyWay.lookup({ method: 'GET', url: '/a/bar-bar', headers: {} }, null)
  findMyWay.lookup({ method: 'GET', url: '/b/bar.bar', headers: {} }, null)
})
...
test('Multi parametric route / 2', t => {
  ...
  findMyWay.lookup({ method: 'GET', url: '/a/bar-bar-baz', headers: {} }, null)
  findMyWay.lookup({ method: 'GET', url: '/b/bar.bar-baz', headers: {} }, null)
})
...
test('Multi parametric route / 4', t => {
  ...
  findMyWay.lookup({ method: 'GET', url: '/a/bar', headers: {} }, null)
  findMyWay.lookup({ method: 'GET', url: '/b/bar', headers: {} }, null)
})
...
test('Multi parametric route with colon separator', t => {
  ...
  findMyWay.on('GET', '/:param1(.*)::suffix1-:param2(.*)::suffix2/static', (req, res, params) => {
    t.equal(params.param1, 'bar')
    t.equal(params.param2, 'bar')
  })

  findMyWay.lookup({ method: 'GET', url: '/bar:suffix', headers: {} }, null)
  findMyWay.lookup({ method: 'GET', url: '/bar:suffix1-bar:suffix2/static', headers: {} }, null)
})
...
test('Multi parametric route with regexp / 2', t => {
  ...
  findMyWay.lookup({ method: 'GET', url: '/a/1111-2222-3333-4444-bar', headers: {} }, null)
  findMyWay.lookup({ method: 'GET', url: '/a/1111-2222-3333-4445-bar/account', headers: {} }, null)

  findMyWay.lookup({ method: 'GET', url: '/b/1111-2222-3333-4444.bar', headers: {} }, null)
...
test('Multi parametric route with regexp and fixed suffix', t => {
  ...
  findMyWay.lookup({ method: 'GET', url: '/a/bar-barbaz-kuux', headers: {} }, null)
  findMyWay.lookup({ method: 'GET', url: '/b/bar.barbaz-kuux', headers: {} }, null)
})
...
test('Nested multi parametric route', t => {
  ...
  findMyWay.lookup({ method: 'GET', url: '/a/bar-bar/b/baz', headers: {} }, null)
  findMyWay.lookup({ method: 'GET', url: '/b/bar.bar/b/baz', headers: {} }, null)
})
...
test('Nested multi parametric route with regexp / 1', t => {
  ...
  findMyWay.lookup({ method: 'GET', url: '/a/bar-42/b/bar', headers: {} }, null)
  findMyWay.lookup({ method: 'GET', url: '/b/bar.42/b/bar', headers: {} }, null)
})
