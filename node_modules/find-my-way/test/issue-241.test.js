...
test('Double colon and parametric children', t => {
  ...
  findMyWay.on('GET', '/::test::bar/:param/::articles', () => {})
  findMyWay.on('GET', '/::test::bar/:param/:article_name', () => {})

  t.same(
    findMyWay.find('GET', '/:test:bar/param_value1/:articles').params,
    { param: 'param_value1' }
  )
  t.same(
    findMyWay.find('GET', '/:test:bar/param_value2/articles_param').params,
