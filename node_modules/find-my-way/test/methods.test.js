...
test('off with nested wildcards with parametric and static', t => {
  ...
  findMyWay.on('GET', '*', (req, res, params) => {
    t.equal(params['*'], '/bar2/first/second')
  })
  findMyWay.on('GET', '/bar1/*', () => {})
  findMyWay.on('GET', '/bar2/*', () => {})
  findMyWay.on('GET', '/bar3/:param', () => {})
  findMyWay.on('GET', '/bar3/*', () => {})
  findMyWay.on('GET', '/bar4/param/hello/test/long/route', () => {})

  var route1 = findMyWay.find('GET', '/bar3/first/second')
  t.equal(route1.params['*'], 'first/second')

  findMyWay.off('GET', '/bar3/*')

  var route2 = findMyWay.find('GET', '/bar3/first/second')
  t.equal(route2.params['*'], '/bar3/first/second')

  findMyWay.off('GET', '/bar2/*')
  findMyWay.lookup(
    { method: 'GET', url: '/bar2/first/second', headers: {} },
    null
  )
})
