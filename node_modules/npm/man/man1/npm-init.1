...
.RS 0
.IP \(bu 4
\fBnpm init bar\fR -> \fBnpm exec create-bar\fR
.IP \(bu 4
\fBnpm init @usr/bar\fR -> \fBnpm exec @usr/create-bar\fR
.IP \(bu 4
\fBnpm init @usr\fR -> \fBnpm exec @usr/create\fR
.IP \(bu 4
\fBnpm init @usr@2.0.0\fR -> \fBnpm exec @usr/create@2.0.0\fR
.IP \(bu 4
\fBnpm init @usr/bar@2.0.0\fR -> \fBnpm exec @usr/create-bar@2.0.0\fR
.RE 0
...
.RS 0
.IP \(bu 4
\fBnpm init bar@latest\fR # fetches and runs the latest \fBcreate-bar\fR from the registry
.IP \(bu 4
\fBnpm init bar@1.2.3\fR # runs \fBcreate-bar@1.2.3\fR specifically
.RE 0

.SS "Forwarding additional options"
.P
Any additional options will be passed directly to the command, so \fBnpm init
bar -- --hello\fR will map to \fBnpm exec -- create-bar --hello\fR.
.P
...
.RS 0
.IP \(bu 4
\fBnpm init bar -y --registry=<url> -- --hello -a\fR
.IP \(bu 4
\fBnpm exec -y --registry=<url> -- create-bar --hello -a\fR
.RE 0
