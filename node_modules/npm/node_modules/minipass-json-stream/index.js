...
class JSONStream extends Minipass {
  ...
  [_setHeaderFooter] (key, value) {
    ...
    // barter has not been emitted yet but header has
    if (this[_barter] !== false && this[_header] === false) {
      this[_barter] = this[_barter] || {}
      this[_barter][key] = value
    }
  }
