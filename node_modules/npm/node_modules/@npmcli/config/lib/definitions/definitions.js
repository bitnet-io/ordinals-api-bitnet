...
// const opts = { ...npm.flatOptions, bar: 'bar' }, but we can maybe
// instead do `npm.config.set('bar', 'bar')` prior to passing the
...
define('before', {
  ...
  description: `
    ...
    to that tag will be used. For example, \`bar@latest\` might install
    \`bar@1.2\` even though \`latest\` is \`2.0\`.
  `,
  flatten,
})
...
define('save-bundle', {
  ...
  flatten (key, obj, flatOptions) {
    ...
    // npm i bar --save-bundle --save-prod <-- should bundle
