...
module.exports = cls => class Reifier extends cls {
  ...
  [_diffTrees] () {
    ...
    // a folder like FOO being "removed" in favor of a folder like "bar",
    // because if we remove node_modules/FOO on case-insensitive systems,
    // it will remove the dep that we *want* at node_modules/bar.
  ...
  async [_saveIdealTree] (options) {
    ...
    if (save) {
      ...
      if (this[_updateAll]) {
        ...
        // user requested 'bar@', and we have a bar@file:../bar, then we should
