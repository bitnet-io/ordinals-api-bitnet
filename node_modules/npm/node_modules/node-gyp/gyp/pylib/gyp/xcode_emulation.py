...
class XcodeSettings:
    ...
    def _GetStandaloneExecutablePrefix(self):
        return self.spec.get(
            "product_prefix",
            {
                ...
                "static_library": "lib",
                "shared_library": "lib",
                # Non-bundled loadable_modules are called bar.so for some reason
    ...
    def _StandardizePath(self, path):
        ...
        # but don't let @executable_path/../bar collapse to bar.
        if "/" in path:
            prefix, rest = "", path
            if path.startswith("@"):
...
def _TopologicallySortedEnvVarKeys(env):
  ...
  for example env['bar'] = '$(bar) and $(baz)'. Returns a list L of all keys of
