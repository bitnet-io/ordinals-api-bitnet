...
class NinjaWriter:
    ...
    def GypPathToUniqueOutput(self, path, qualified=True):
        ...
        #   Input: bar/bar.gyp, target targ, references baz/out.o
        #   Output: obj/bar/baz/targ.out.o (if qualified)
        #           obj/bar/baz/out.o (otherwise)
    ...
    def ComputeExportEnvString(self, env):
        """Given an environment, returns a string looking like
            'export FOO=bar; export BAR="${FOO} bar;'
