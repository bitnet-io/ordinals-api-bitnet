...
# file for
#     Chromium\ Framework.framework/bar
# is for example
#     out/Release/.deps/out/Release/Chromium?Framework.framework/bar
...
"""
    """
# Command definitions:
# - cmd_bar is the actual command to run;
# - quiet_cmd_bar is the brief-output summary of the command.
...
# do_cmd: run a command via the above cmd_bar names, if necessary.
...
class MakefileWriter:
    """MakefileWriter packages up the writing of one target-specific barbar.mk.
...
"""
    ...
    def Write(
        ...
        # follow use names like extra_bar.
        extra_outputs = []
        extra_sources = []
        extra_link_deps = []
    ...
    def WriteActions(
        ...
        for action in actions:
            ...
            # cmd_bar. Toplevel variables can't handle things that change per
    ...
    def WriteRules(
        ...
        for rule in rules:
            ...
            for rule_source in rule.get("rule_sources", []):
                ...
                # called cmd_bar. Toplevel variables can't handle things that change
...
# See "Target-specific Variable Values" in the GNU Make manual."""
    ...
    def ComputeOutputBasename(self, spec):
        ...
        E.g., the loadable module 'barbar' in directory 'baz' will produce
          'libbarbar.so'
        """
    ...
    def ComputeDeps(self, spec):
        ...
        if "dependencies" in spec:
            ...
            # TODO: It seems we need to transitively link in libraries (e.g. -lbar)?
    ...
    def WriteList(self, value_list, variable=None, prefix="", quoter=QuoteIfNecessary):
        ...
        E.g. WriteList(['a','b'], 'bar', prefix='blah') writes out
             bar = blaha blahb
...
def GenerateOutput(target_list, target_dicts, data, params):
    ...
    def CalculateMakefilePath(build_file, base_name):
        ...
        # E.g. "bar/bar" when we're constructing targets for "bar/bar/baz.gyp".
