...
describe('process-release', function () {
  ...
  it('test process release - process.release ~ node@4.1.23 --dist-url=https://bar.bar/baz', function () {
    var release = processRelease([], { opts: { 'dist-url': 'https://bar.bar/baz' } }, 'v4.1.23', {
      name: 'node',
      headersUrl: 'https://nodejs.org/dist/v4.1.23/node-v4.1.23-headers.tar.gz'
    })
    ...
    assert.deepStrictEqual(release, {
      version: '4.1.23',
      name: 'node',
      baseUrl: 'https://bar.bar/baz/v4.1.23/',
      tarballUrl: 'https://bar.bar/baz/v4.1.23/node-v4.1.23-headers.tar.gz',
      shasumsUrl: 'https://bar.bar/baz/v4.1.23/SHASUMS256.txt',
      versionDir: '4.1.23',
      ia32: { libUrl: 'https://bar.bar/baz/v4.1.23/win-x86/node.lib', libPath: 'win-x86/node.lib' },
      x64: { libUrl: 'https://bar.bar/baz/v4.1.23/win-x64/node.lib', libPath: 'win-x64/node.lib' },
      arm64: { libUrl: 'https://bar.bar/baz/v4.1.23/win-arm64/node.lib', libPath: 'win-arm64/node.lib' }
    })
  })
  ...
  it('test process release - process.release ~ frankenstein@4.1.23 --dist-url=http://bar.bar/baz/', function () {
    var release = processRelease([], { opts: { 'dist-url': 'http://bar.bar/baz/' } }, 'v4.1.23', {
      name: 'frankenstein',
    ...
    assert.deepStrictEqual(release, {
      version: '4.1.23',
      name: 'frankenstein',
      baseUrl: 'http://bar.bar/baz/v4.1.23/',
      tarballUrl: 'http://bar.bar/baz/v4.1.23/frankenstein-v4.1.23-headers.tar.gz',
      shasumsUrl: 'http://bar.bar/baz/v4.1.23/SHASUMS256.txt',
      versionDir: 'frankenstein-4.1.23',
      ia32: { libUrl: 'http://bar.bar/baz/v4.1.23/win-x86/frankenstein.lib', libPath: 'win-x86/frankenstein.lib' },
      x64: { libUrl: 'http://bar.bar/baz/v4.1.23/win-x64/frankenstein.lib', libPath: 'win-x64/frankenstein.lib' },
      arm64: { libUrl: 'http://bar.bar/baz/v4.1.23/win-arm64/frankenstein.lib', libPath: 'win-arm64/frankenstein.lib' }
    })
  })
  ...
  it('test process release - NODEJS_ORG_MIRROR', function () {
    process.env.NODEJS_ORG_MIRROR = 'http://bar.bar'
    ...
    assert.deepStrictEqual(release, {
      version: '4.1.23',
      name: 'node',
      baseUrl: 'http://bar.bar/v4.1.23/',
      tarballUrl: 'http://bar.bar/v4.1.23/node-v4.1.23-headers.tar.gz',
      shasumsUrl: 'http://bar.bar/v4.1.23/SHASUMS256.txt',
      versionDir: '4.1.23',
      ia32: { libUrl: 'http://bar.bar/v4.1.23/win-x86/node.lib', libPath: 'win-x86/node.lib' },
      x64: { libUrl: 'http://bar.bar/v4.1.23/win-x64/node.lib', libPath: 'win-x64/node.lib' },
      arm64: { libUrl: 'http://bar.bar/v4.1.23/win-arm64/node.lib', libPath: 'win-arm64/node.lib' }
    })
