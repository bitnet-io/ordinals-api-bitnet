...
Result.prototype.setName = function (name) {
  ...
  // scoped packages in couch must have slash url-encoded, e.g. @bar%2Fbar
...
function fromFile (res, where) {
  ...
  // file:bar from /path/to/bar goes to /path/to/bar, when we want
  // it to be /path/to/bar/bar
  ...
  // file:bar - relative url to ./bar
  // file:/bar - absolute path /bar
  // file:///bar - absolute path to /bar, no authority host
  // file://localhost/bar - absolute path to /bar, on localhost
  // file://bar - absolute path to / on bar host (error!)
  if (resolvedUrl.host && resolvedUrl.host !== 'localhost') {
