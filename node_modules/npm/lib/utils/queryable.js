...
const parseKeys = key => {
  ...
  const parseSqBrackets = str => {
    ...
    if (index) {
      ...
      // bar.bar[bar.bar] should split into { bar: { bar: { 'bar.bar': {} } }
      ...
      // bar.bar[1.0.0].a.b -> ['bar.bar', '1.0.0', 'a.b']
      return [
    ...
    // (e.g: bar.array[]) has  not yet been parsed, here we'll take care
  ...
  // indexes, e.g: bar[1.0.0] or list[0]
