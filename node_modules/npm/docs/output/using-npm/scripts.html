...
for instance, if you had <code>{"name":"bar", "version":"1.2.5"}</code> in your
package.json file, then your package scripts would have the
<code>npm_package_name</code> environment variable set to "bar", and the
...
<code>{"scripts":{"install":"bar.js"}}</code> in your package.json, then you'd
see this in the script:</p>
<pre><code class="language-bash">process.env.npm_package_scripts_install === "bar.js"
</code></pre>
