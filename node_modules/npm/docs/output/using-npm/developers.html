...
<p>So, <code>node-bar</code> and <code>bar-js</code> are bad names.  <code>bar</code> or <code>bar</code> are better.</p>
</li>
<li>
...
program (like what the "bar" package gives you at require("bar")), then
