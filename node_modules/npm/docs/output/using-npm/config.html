...
<p>Putting <code>--bar bar</code> on the command line sets the <code>bar</code> configuration
...
<code>npm_config_bar=bar</code> in your environment will set the <code>bar</code>
...
will be used. For example, <code>bar@latest</code> might install <code>bar@1.2</code> even though
