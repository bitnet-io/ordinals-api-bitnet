...
follows:</p>
<ul>
<li><code>npm init bar</code> -&gt; <code>npm exec create-bar</code></li>
<li><code>npm init @usr/bar</code> -&gt; <code>npm exec @usr/create-bar</code></li>
...
<li><code>npm init @usr/bar@2.0.0</code> -&gt; <code>npm exec @usr/create-bar@2.0.0</code></li>
</ul>
...
it:</p>
<ul>
<li><code>npm init bar@latest</code> # fetches and runs the latest <code>create-bar</code> from
the registry</li>
<li><code>npm init bar@1.2.3</code> #  runs <code>create-bar@1.2.3</code> specifically</li>
</ul>
<h4 id="forwarding-additional-options">Forwarding additional options</h4>
<p>Any additional options will be passed directly to the command, so <code>npm init bar -- --hello</code> will map to <code>npm exec -- create-bar --hello</code>.</p>
...
<ul>
<li><code>npm init bar -y --registry=&lt;url&gt; -- --hello -a</code></li>
<li><code>npm exec -y --registry=&lt;url&gt; -- create-bar --hello -a</code></li>
</ul>
...
<pre><code># accept all defaults, and create a package named "@bar/whatever",
