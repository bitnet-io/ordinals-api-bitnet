...
<code>prefix</code> folder.  This is so that <code>npm install bar@1.2.3</code> will install
...
<p>When you run <code>npm install bar@1.2.3</code>, then the package is loaded into
the cache, and then unpacked into <code>./node_modules/bar</code>.  Then, any of
bar's dependencies are similarly unpacked into
<code>./node_modules/bar/node_modules/...</code>.</p>
...
<p>Consider the case above, where <code>bar -&gt; bar -&gt; baz</code>.  Imagine if, in
addition to that, baz depended on bar, so you'd have:
<code>bar -&gt; bar -&gt; baz -&gt; bar -&gt; baz ...</code>.  However, since the folder
structure is: <code>bar/node_modules/bar/node_modules/baz</code>, there's no need to
...
<code>bar/node_modules/bar</code>.</p>
...
<p>Since bar depends directly on <code>bar@1.2.3</code> and <code>baz@1.2.3</code>, those are
installed in bar's <code>node_modules</code> folder.</p>
<p>Even though the latest copy of blerg is 1.3.7, bar has a specific
