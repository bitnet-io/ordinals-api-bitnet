...
For example, if you add a file to `node_modules/bar/lib/bar.js`, then the
modified time on `node_modules/bar` will not reflect this change.  If you
...
* version: a specifier that varies depending on the nature of the package,
  and is usable in fetching a new copy of it.
    ...
    * git sources: This is a git specifier with resolved committish. (eg,
      `git+https://example.com/bar/bar#115311855adb0789a0466714ed48a1499ffea97e`)
