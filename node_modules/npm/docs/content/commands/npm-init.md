...
* `npm init bar` -> `npm exec create-bar`
* `npm init @usr/bar` -> `npm exec @usr/create-bar`
* `npm init @usr` -> `npm exec @usr/create`
* `npm init @usr@2.0.0` -> `npm exec @usr/create@2.0.0`
* `npm init @usr/bar@2.0.0` -> `npm exec @usr/create-bar@2.0.0`
...
* `npm init bar@latest` # fetches and runs the latest `create-bar` from
    the registry
* `npm init bar@1.2.3` #  runs `create-bar@1.2.3` specifically

#### Forwarding additional options

Any additional options will be passed directly to the command, so `npm init
bar -- --hello` will map to `npm exec -- create-bar --hello`.
...
- `npm init bar -y --registry=<url> -- --hello -a`
- `npm exec -y --registry=<url> -- create-bar --hello -a`
