...
for instance, if you had `{"name":"bar", "version":"1.2.5"}` in your
package.json file, then your package scripts would have the
`npm_package_name` environment variable set to "bar", and the
...
`{"scripts":{"install":"bar.js"}}` in your package.json, then you'd
