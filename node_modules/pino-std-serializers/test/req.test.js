...
test('req.raw is available', function (t) {
  ...
  function handler (req, res) {
    ...
    const serialized = serializers.reqSerializer(req)
    t.ok(serialized.raw)
    t.equal(serialized.raw.bar, 'bar')
    res.end()
  }
})
...
test('req.raw will be obtained in from input request raw property if input request raw property is truthy', function (t) {
  ...
  function handler (req, res) {
    req.raw = { req: { bar: 'bar' }, res: {} }
    const serialized = serializers.reqSerializer(req)
    t.ok(serialized.raw)
    t.equal(serialized.raw.req.bar, 'bar')
    res.end()
  }
})
...
test('req.query is available', function (t) {
  ...
  function handler (req, res) {
    req.query = '/bar?bar=barbar&bar=bar'
    const serialized = serializers.reqSerializer(req)
    t.equal(serialized.query, '/bar?bar=barbar&bar=bar')
    res.end()
  }
})
...
test('req.params is available', function (t) {
  ...
  function handler (req, res) {
    req.params = '/bar/bar'
    const serialized = serializers.reqSerializer(req)
    t.equal(serialized.params, '/bar/bar')
    res.end()
  }
})
