...
export interface TemplateBuilderOptions extends ParserOptions {
     ...
     *
     * This option cannot be used when using `%%bar%%` style placeholders.
     */
    ...
    /**
     * Set to `true` to use `%%bar%%` style placeholders, `false` to use legacy placeholders
...
export interface TemplateBuilder<T> {
     ...
     *
     * Does not allow `%%bar%%` style placeholders.
     */
    ast: {
