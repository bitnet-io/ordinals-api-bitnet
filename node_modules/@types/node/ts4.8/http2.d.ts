...
declare module 'http2' {
    ...
    export interface ServerHttp2Session extends Http2Session {
         ...
         * HTTP URL `'https://example.org/bar/bar'` is the ASCII string`'https://example.org'`. An error will be thrown if either the given string
         ...
         * origin will be derived. For instance, the origin for the HTTP URL`'https://example.org/bar/bar'` is the ASCII string`'https://example.org'`. An error will be thrown if either the given
         * string
         * cannot be parsed as a URL or if a valid origin cannot be derived.
         *
    ...
    export class Http2ServerResponse extends stream.Writable {
         ...
         * response.setHeader('Set-Cookie', ['bar=bar', 'bar=baz']);
         *
         * const headerNames = response.getHeaderNames();
         * // headerNames === ['bar', 'set-cookie']
         * ```
         * @since v8.4.0
         */
         ...
         * // headers === { bar: 'bar', 'set-cookie': ['bar=bar', 'bar=baz'] }
         * ```
         * @since v8.4.0
         */
