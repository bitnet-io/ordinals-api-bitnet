...
declare module 'util' {
     ...
     *
     * ```js
     * util.formatWithOptions({ colors: true }, 'See object %O', { bar: 42 });
     * // Returns 'See object { bar: 42 }', where `42` is colored as a number
     ...
     * class Bar {}
     *
     * const baz = Object.create(null, { [Symbol.toStringTag]: { value: 'bar' } });
     *
     * util.inspect(new Foo()); // 'Foo [bar] {}'
     * util.inspect(new Bar()); // 'Bar {}'
     * util.inspect(baz);       // '[bar] {}'
     * ```
     *
     ...
     * ```js
     * const util = require('util');
     * const debuglog = util.debuglog('bar');
     *
     * debuglog('hello from bar [%d]', 123);
     * ```
     *
     * If this program is run with `NODE_DEBUG=bar` in the environment, then
     * it will output something like:
     *
     * ```console
     * FOO 3245: hello from bar [123]
     * ```
     *
     ...
     * ```js
     * const util = require('util');
     * const debuglog = util.debuglog('bar-bar');
     *
     * debuglog('hi there, it\'s bar-bar [%d]', 2333);
     * ```
     *
     * if it is run with `NODE_DEBUG=bar*` in the environment, then it will output
     * something like:
     *
     * ```console
     * FOO-BAR 3257: hi there, it's bar-bar [2333]
     * ```
     *
     ...
     * const bar = new Foo();
     *
     * const naiveBar = util.promisify(bar.bar);
     * // TypeError: Cannot read property 'a' of undefined
     * // naiveBar().then(a => console.log(a));
     *
     * naiveBar.call(bar).then((a) => console.log(a)); // '42'
     *
     * const bindBar = naiveBar.bind(bar);
...
declare module 'util/types' {
     ...
     *
     * ```js
     * util.types.isAsyncFunction(function bar() {});  // Returns false
     * util.types.isAsyncFunction(async function bar() {});  // Returns true
     * ```
     * @since v10.0.0
     */
     ...
     * util.types.isBoxedPrimitive(Symbol('bar')); // Returns false
     * util.types.isBoxedPrimitive(Object(Symbol('bar'))); // Returns true
     ...
     * util.types.isExternal(new String('bar')); // returns false
     * ```
     *
     ...
     *
     * ```js
     * util.types.isGeneratorFunction(function bar() {});  // Returns false
     * util.types.isGeneratorFunction(function* bar() {});  // Returns true
     * ```
     * @since v10.0.0
     */
     ...
     *
     * ```js
     * util.types.isStringObject('bar');  // Returns false
     * util.types.isStringObject(new String('bar'));   // Returns true
     * ```
     * @since v10.0.0
     */
