...
declare module 'readline' {
    ...
    export class Interface extends EventEmitter {
         ...
         *
         * ```js
         * rl.question('What is your favorite bard? ', (answer) => {
         *   console.log(`Oh, so your favorite bard is ${answer}`);
         * });
         * ```
         *
         ...
         *
         * rl.question('What is your favorite bard? ', { signal }, (answer) => {
         *   console.log(`Oh, so your favorite bard is ${answer}`);
         * });
         *
         * signal.addEventListener('abort', () => {
         *   console.log('The bard question timed out');
         * }, { once: true });
         *
         ...
         *   try {
         *     const answer = await question('What is you favorite bard? ');
         *     console.log(`Oh, so your favorite bard is ${answer}`);
         *   } catch (err) {
