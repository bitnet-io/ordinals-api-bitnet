...
declare namespace yargs {
    ...
    interface Argv<T = {}> {
         ...
         * If `.array('bar')` is set, `--bar bar bar` will be parsed as `['bar', 'bar']` rather than as `'bar'`.
         * Also, if you use the option multiple times all the values will be flattened in one array so `--bar bar --bar bar` will be parsed as `['bar', 'bar']`
         *
         ...
         *
         * Use the "__" separator in the environment variable to indicate nested options. (e.g. prefix_nested__bar => nested.bar)
         *
    ...
    // not implemented: yargs decamelizes (converts barBar to bar-bar)

    /** Convert literal string types like 'bar-bar' to 'FooBar' */
    ...
    /** Convert literal string types like 'bar-bar' to 'barBar' */
    ...
    /** Convert literal string types like 'bar-bar' to 'barBar', allowing all `PropertyKey` types */
