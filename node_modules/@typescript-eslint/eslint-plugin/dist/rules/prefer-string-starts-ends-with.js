...
exports.default = (0, util_1.createRule)({
    ...
    create(context) {
         ...
         *   E.g., `bar` → `bar.length` / `"bar"` → `"bar".length`
         ...
         *
         * - `obj[bar]` → the range of `[bar]`
         * - `obf.bar` → the range of `.bar`
         * - `(obj).bar` → the range of `.bar`
         *
         ...
         * For example: `bar.slice(0, 3) === 'bar'` → `bar.startsWith('bar')`
         ...
         * For example: `bar.indexOf('bar') === 0` → `bar.startsWith('bar')`
         * @param fixer The rule fixer.
         * @param node The node which was reported.
         * @param kind The kind of the report.
        ...
        return {
            ...
            // bar.lastIndexOf(bar) === bar.length - bar.length
            [[
            ...
            // bar.slice(0, 3) === 'bar'
            // bar.slice(-3) === 'bar'
            // bar.slice(-3, bar.length) === 'bar'
            // bar.substring(0, 3) === 'bar'
            // bar.substring(bar.length - 3) === 'bar'
            // bar.substring(bar.length - 3, bar.length) === 'bar'
            [[
