...
// Mixed (strings & numbers) items; result is: 'bar.0.baz'
const path: Join<['bar', 0, 'baz'], '.'> = ['bar', 0, 'baz'].join('.');

// Only string items; result is: 'bar.bar.baz'
const path: Join<['bar', 'bar', 'baz'], '.'> = ['bar', 'bar', 'baz'].join('.');
...
// Contains nullish items; result is: 'bar..baz..xyz'
const path: Join<['bar', undefined, 'baz', null, 'xyz'], '.'> = ['bar', undefined, 'baz', null, 'xyz'].join('.');
