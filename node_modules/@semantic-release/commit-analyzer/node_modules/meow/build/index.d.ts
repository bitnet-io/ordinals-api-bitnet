...
const someVariable: CamelCase<'bar-bar'> = 'barBar';
...
type Flag<PrimitiveType extends FlagType, Type, IsMultiple = false> = {
	...
	*/
	...
	Multiple values are provided by specifying the flag multiple times, for example, `$ bar -u rainbow -u cat`. Space- or comma-separated values [currently *not* supported](https://github.com/sindresorhus/meow/issues/164).
...
type Options<Flags extends AnyFlags> = {
	...
	*/
	...
	By default, the argument `5` in `$ bar 5` becomes a string. Enabling this would infer it as a number.
