...
A commit message consists of a **header**, **body** and **barter**.  The header has a **type**, **scope** and **subject**:
...
If the prefix is `feat`, `fix` or `perf`, it will appear in the changelog. However if there is any [BREAKING CHANGE](#barter), the commit will always appear in the changelog.
...
The barter should contain any information about **Breaking Changes** and is also the place to
