...
test('object with field with type union of multiple objects', (t) => {
  ...
  t.equal(stringify({ oneOfSchema: { bar: 'bar' } }), '{"oneOfSchema":{"bar":"bar"}}')
})
...
test('one array item match oneOf types', (t) => {
  ...
  t.equal(stringify({ data: ['bar'] }), '{"data":["bar"]}')
  t.equal(stringify({ data: [1] }), '{"data":[1]}')
  t.throws(() => stringify({ data: [false, 'bar'] }))
})
...
test('some array items match oneOf types', (t) => {
  ...
  t.equal(stringify({ data: ['bar', 5] }), '{"data":["bar",5]}')
  t.throws(() => stringify({ data: [false, 'bar', true, 5] }))
})
