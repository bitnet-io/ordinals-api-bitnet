...
test('object that is simultaneously a string and a json', (t) => {
  ...
  const valueObj = stringify({ simultaneously: { bar: likeObjectId } })
  t.equal(valueObj, '{"simultaneously":{"bar":"hello"}}')
})
...
test('should throw an error when type is array and object is not an array', (t) => {
  ...
  const stringify = build(schema)
  t.throws(() => stringify({ arr: { bar: 'hello' } }), new TypeError('The value of \'#/properties/arr\' does not match schema definition.'))
})
...
test('should throw an error when type is array and object is not an array with external schema', (t) => {
  ...
  t.throws(() => stringify({ arr: { bar: 'hello' } }), new TypeError('The value of \'arrayOfNumbers#/definitions/arr\' does not match schema definition.'))
})
