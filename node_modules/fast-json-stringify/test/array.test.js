...
test('array items is a list of schema and additionalItems is false /1', (t) => {
  ...
  const stringify = build(schema)
  t.throws(() => stringify({ bar: ['bar', 'bar'] }), new Error('Item at 1 does not match schema definition.'))
})
...
test('array items is a list of schema and additionalItems is false /2', (t) => {
  ...
  t.throws(() => stringify({ bar: [1, 'bar'] }), new Error('Item at 0 does not match schema definition.'))
  t.throws(() => stringify({ bar: ['bar', 1] }), new Error('Item at 1 does not match schema definition.'))
  t.throws(() => stringify({ bar: ['bar', 'bar', 'baz'] }), new Error('Item at 2 does not match schema definition.'))
})
...
test('array items is a schema and additionalItems is false', (t) => {
  ...
  t.same(stringify({ bar: ['bar', 'bar'] }), '{"bar":["bar","bar"]}')
  t.equal(validate({ bar: ['bar', 'bar'] }), true)
})
...
test('different arrays with same item schemas', (t) => {
  ...
  const stringify = build(schema)
  const data = { array1: ['bar'], array2: ['bar', 'bar'] }

  t.equal(stringify(data), '{"array1":["bar"],"array2":["bar","bar"]}')
})
