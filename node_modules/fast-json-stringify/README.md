...
console.log(stringify(obj)) // '{"matchbar":"42","otherbar":"str","matchnum":3,"nickname":"nick"}'
```
...
console.log(stringify(obj)) // '{"nickname":"nick","matchbar":"42","otherbar":"str","matchnum":3,"nomatchstr":"valar morghulis",nomatchint:"313"}'
```
