...
t.test('basic serializer usage', t => {
  ...
  t.equal(serializeFunc({ version: '1', bar: 42 }), '{"version":"1","bar":42}')
  t.equal(serializeFunc({ version: '2', bar: 'hello' }), '{"version":"2","bar":"hello"}')
  t.equal(serializeFunc({ version: '3', bar: 'hello' }), '{"version":"3"}')
  t.equal(serializeFunc({ version: '2', bar: ['not', 1, { string: 'string' }] }), '{"version":"2","bar":"not,1,[object Object]"}')
})
